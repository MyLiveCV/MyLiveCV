...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle("My Live CV")
    .setDescription(
      "My Live CV is a free and open source resume builder that's built to make the mundane tasks of creating, updating and sharing your resume as easy as 1, 2, 3.",
    )
