  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built My Live CV mostly by myself during my spare time, with a lot of help from other
    ...
    <CardFooter>
      ...
      >
        ...
        <span className="line-clamp-1">{t`Donate to My Live CV`}</span>
      </a>
    </CardFooter>
  </Card>
);
...
const IssuesCard = () => (
  <Card className="space-y-4">
    ...
    <CardFooter className="space-x-4">
      <a
        href="https://github.com/MyLiveCV/MyLiveCV/issues/new/choose"
        className={cn(buttonVariants({ size: "sm" }))}
        rel="noopener noreferrer nofollow"
        target="_blank"
      >
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for My Live CV, and I'm
