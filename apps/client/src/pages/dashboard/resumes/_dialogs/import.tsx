        ...
        <Form {...form}>
          <form className="space-y-4">
            <DialogHeader>
              ...
              <DialogDescription>
                {t`Upload a file from one of the accepted sources to parse existing data and import it into My Live CV for easier editing.`}
              </DialogDescription>
            </DialogHeader>
                  ...
                  <FormControl>
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="reactive-resume-json">My Live CV (.json)</SelectItem>
                        {/* eslint-disable-next-line lingui/no-unlocalized-strings */}
