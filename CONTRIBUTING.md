...
Finally, create a pull request to merge the changes on your forked repository to the original repository hosted on MyLiveCV/MyLiveCV. I can take a look at the changes you've made when I have the time and have it merged onto the app.
